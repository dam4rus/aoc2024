...
import { part1, depthCount, generateOperators } from "./index";
...
describe("Day 7", () => {
  it("depth 1"),
    () => {
      assert.strictEqual(depthCount(1), 1);
    };
  it("depth 2"),
    () => {
      assert.strictEqual(depthCount(2), 2);
    };
  it("depth 3"),
    () => {
      assert.strictEqual(depthCount(3), 4);
    };
  it("depth 4"),
    () => {
      assert.strictEqual(depthCount(4), 8);
    };
